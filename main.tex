...
\hyperref[_bookmark103]{Restricciones Clasificadas 38}
...
\item
  \hyperref[indice-de-multimedia-con-enlaces]{Índice de multimedia
  con enlaces 50}
\end{enumerate}
...
formalizaron 18 RNF (RNF-01 a RNF-18), superando el mínimo de 15
...
\\
\textbf{RNF-17} & Privacidad (Conservación de datos) & El sistema
debe aplicar políticas de retención sobre los datos personales del
propietario y eliminarlos o anonimizarlos automáticamente al vencer
el plazo de conservación definido. & 100\% de los registros con
plazo de conservación vencido eliminados o anonimizados dentro de
un máximo de 30 días desde el vencimiento. & LOPDP Art. 10 lit. i)
(RL-03) \\
\textbf{RNF-18} & Privacidad (Respuesta a incidentes) & El sistema
y el equipo responsable deben contar con un procedimiento
documentado para notificar vulneraciones de seguridad de datos
personales. & Notificación a la Autoridad de Protección de Datos en
un plazo $\leq$ 5 días desde la detección, y al titular afectado en
un plazo $\leq$ 3 días. & LOPDP Art. 43, 46 (RL-13) \\
\end{longtable}
}
...
clínica y administrativa declarada. & RF-01 \\
...
la rectificación de sus datos personales, atendible en 15 días. &
RF-26 \\
...
Autoridad ($\leq$ 5 días) y al titular ($\leq$ 3 días). & RNF-18, RF-23 \\
...
\bottomrule\noalign{}
\endlastfoot
RF-01 & RF & Must & Desempeño & Alto & IEEE 29148, LOPDP Art. 10 lit. e) & CU-01 &
\begin{minipage}[t]{\linewidth}\raggedright
Todas las pantallas\\
(responsive)\strut
\end{minipage} \\
...
Historiales Clínicos\strut
\end{minipage} \\
RF-04 & RF & Must & Básico & Alto & --- & CU-02 &
\begin{minipage}[t]{\linewidth}\raggedright
Registro de\\
Consulta\strut
\end{minipage} \\
...
Bodega\strut
\end{minipage} \\
RF-07 & RF & Must & Básico & Alto & --- & CU-07 &
\begin{minipage}[t]{\linewidth}\raggedright
Facturación y\\
Cobro\strut
\end{minipage} \\
RF-08 & RF & Must & Atractivo & Alto & --- & CU-07 &
\begin{minipage}[t]{\linewidth}\raggedright
Facturación y\\
Cobro\strut
\end{minipage} \\
RF-09 & RF & Must & Básico & Medio & --- & CU-02 &
\begin{minipage}[t]{\linewidth}\raggedright
Comunicación\\
con Dueños\strut
\end{minipage} \\
RF-10 & RF & Must & Atractivo & Medio & LOPDP Art. 33, 34, 35 & CU-02 &
\begin{minipage}[t]{\linewidth}\raggedright
Comunicación\\
con Dueños\strut
\end{minipage} \\
...
de Usuarios\strut
\end{minipage} \\
RNF-06 & RNF & Should & Básico & Medio & --- & CU-03 &
\begin{minipage}[t]{\linewidth}\raggedright
Gestión de\\
Historiales Clínicos*\strut
\end{minipage} \\
...
Diagnóstico IA\strut
\end{minipage} \\
RNF-17 & RNF & Must & Básico & Alto & LOPDP Art. 10 lit. i) & --- &
No aplica (proceso automatizado interno) \\
RNF-18 & RNF & Must & Básico & Alto & LOPDP Art. 43, 46 & --- &
No aplica (procedimiento operativo) \\
RST-01 & RST & N/A & N/A & Alto & --- & --- & No aplica \\
RST-02 & RST & N/A & N/A & Alto & --- & CU-01 & No aplica \\
RST-03 & RST & N/A & N/A & Alto & --- & CU-02 & No aplica \\
...
Diagnóstico IA\strut
\end{minipage} \\
RST-06 & RST & N/A & N/A & Medio & --- & CU-01 &
\begin{minipage}[t]{\linewidth}\raggedright
No aplica\\
(módulo interno)\strut
\end{minipage} \\
RST-07 & RST & N/A & N/A & Alto & --- & CU-03 &
\begin{minipage}[t]{\linewidth}\raggedright
No aplica\\
(módulo interno)\strut
\end{minipage} \\
RST-08 & RST & N/A & N/A & Alto & --- & CU-02 &
\begin{minipage}[t]{\linewidth}\raggedright
Panel de\\
Diagnóstico IA\strut
\end{minipage} \\
...
y Restricciones (RST), para un total de 52 elementos (25 RF + 18 RNF +
9 RST).
\end{quote}
...
\end{minipage} & 18 & RNF-01 a RNF-18 & Sección 3.3 \\
...
una clínica veterinaria pequeña, priorizando bajo costo de
implementación y operación. & \begin{minipage}[t]{\linewidth}\raggedright
Presupuestaria
\end{minipage} \\
RST-02 & El sistema debe diseñarse con una arquitectura que permita
su ejecución multiplataforma (web y/o móvil) sin duplicar la lógica
de negocio. & \begin{minipage}[t]{\linewidth}\raggedright
Tecnológica
\end{minipage} \\
RST-03 & El módulo de sincronización offline debe implementarse
mediante cola local de operaciones, sin réplica completa de la base
de datos en el cliente. & \begin{minipage}[t]{\linewidth}\raggedright
Técnica / Hardware
\end{minipage} \\
RST-04 & El módulo de Inteligencia Artificial debe mantenerse
desacoplado del backend principal (arquitectura cliente-servidor con
API REST). & \begin{minipage}[t]{\linewidth}\raggedright
Arquitectónica
\end{minipage} \\
RST-05 & Toda sugerencia generada por el módulo de IA debe quedar
sujeta a revisión y validación humana antes de aplicarse. &
\begin{minipage}[t]{\linewidth}\raggedright
Ética / Regulatoria
\end{minipage} \\
...
Seguridad
\end{minipage} \\
RST-07 & El registro de auditoría de los historiales clínicos no
debe permitir edición ni eliminación retroactiva. &
\begin{minipage}[t]{\linewidth}\raggedright
Seguridad
\end{minipage} \\
RST-08 & El sistema no debe emitir diagnósticos definitivos ni
prescripciones automatizadas; toda salida del módulo de IA tiene
...
de salud animal ni emitir facturación electrónica certificada ante
el SRI en la versión 1.0. & \begin{minipage}[t]{\linewidth}\raggedright
Regulatoria / Alcance
\end{minipage} \\
\end{longtable}
}
...
CU-04 Controlar Inventario \\
EV-02 & RF-07 --- Registro del proceso de cobro & CU-07 Gestionar
Facturación y Cobro \\
EV-02 & RF-08 --- Módulo de facturación ágil & CU-07 Gestionar
Facturación y Cobro \\
...
El historial de commits debe evidenciar el desarrollo progresivo del proyecto, incluyendo modificaciones relacionadas con la documentación, evidencias, modelado, trazabilidad, auditoría de calidad, requisitos de IA y defensa técnica. De esta manera, el repositorio permite comprobar la evolución del trabajo y mantener una adecuada trazabilidad de los cambios realizados, con commits distribuidos entre los integrantes y en el tiempo, conforme a lo exigido en el criterio C8 de la Rúbrica PE5.
